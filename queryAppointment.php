...
if ($function == "getCalenderFilters"){ // get new appointments
	...
	//else echo $_SESSION['ID'];
        ...
        $t=time();
	$query = "INSERT INTO visitors_appointment(AppointmentDate, AppointmentTime, Reason, Email, PhoneNumber, PhysicianID) VALUES('".$_POST['date']."',$t,'".$_POST['reason']."','".$_POST['mail']."','".$_POST['phonenumber']."', '".$_POST['phy']."');";

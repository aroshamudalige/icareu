...
function editGuardian(){
    //var GuardianDetails = document.getElementsByName("editGuardianInfo");
	...
	var data = new FormData();
        if (document.getElementById("editGuardiangender").checked) {
        data.append("gender",document.getElementById("editGuardiangender").value);
        }
	data.append("func","editGuardianDetails");
        data.append("name",document.getElementById("editGuardianName").value);
        data.append("nic",document.getElementById("editGuardianNic").value);
        
        data.append("contact",document.getElementById("editGuardianContact").value);
        data.append("address",document.getElementById("editGuardianAddr").value);
...
function viewElderPillPod(){
	...
	xhr.onreadystatechange = function(){
		if(xhr.readyState==4 && xhr.status==200){
			elderReportList.innerHTML= '<input type="button" value="Add Report" style="margin-bottom:10px" onClick="document.getElementById('+"'elderReportAdd'"+').style.display='+"'block'"+';document.getElementById('+"'elderReportList'"+').style.display='+"'none'"+';">';
			elderReportList.innerHTML+= xhr.responseText.trim(); 
			elderReportPreview.style.display="none";
			elderReportList.style.display="block";
			document.getElementById("viewElderPillPodDetails_Loader").style.display="block";
		}
	}
	xhr.open('post','queryElder.php',true);
	xhr.send(data);*/
